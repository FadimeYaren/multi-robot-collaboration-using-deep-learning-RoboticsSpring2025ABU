        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if event.key == pygame.K_UP:
                    ...
                    fx, fy = rx, ry
                    if agent_dir == "move_up":
                        fy -= 1
                    elif agent_dir == "move_down":
                        fy += 1
                    elif agent_dir == "move_left":
                        fx -= 1
                    elif agent_dir == "move_right":
                        fx += 1
                    ...
                    if 0 <= fx < GRID_WIDTH and 0 <= fy < GRID_HEIGHT:
                        ...
                        if agent_item is None:
                            ...
                            # Tezgaha bırak
                                ...
                                agent_item = None  # Şimdilik sadece bırakıyoruz

                            # Et pişirme
                            elif tile == "P" and agent_item["type"] == "Meat" and agent_item["state"] == "Raw":
                                agent_item["state"] = "Cooked"  # Basit model: hemen pişiyor

                            # Teslimat
                            elif tile == "D":
                                agent_item = None  # Sipariş kontrolü henüz yok
